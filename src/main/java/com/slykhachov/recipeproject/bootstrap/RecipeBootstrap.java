package com.slykhachov.recipeproject.bootstrap;

import com.slykhachov.recipeproject.domain.*;
import com.slykhachov.recipeproject.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        tacosRecipe.setUrl("http://example.com");
